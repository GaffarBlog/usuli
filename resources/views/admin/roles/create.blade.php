...
@section('title', 'নতুন ভূমিকা — উসুলি অ্যাডমিন')
...
@section('content')
    <div>
        ...
        <nav class="mb-4 text-sm text-faint">
            ...
            <span class="text-ink">নতুন</span>
        </nav>

        <h1 class="mb-6 font-serif text-2xl font-semibold text-ink">নতুন ভূমিকা</h1>
        ...
        <form action="{{ route('admin.roles.create') }}" method="POST"
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="3"
                          class="w-full rounded-lg border border-hairline bg-gray-50/50 px-4 py-2.5 text-sm text-ink outline-none transition-colors focus:border-brand focus:bg-white focus:ring-1 focus:ring-brand/20"
                          placeholder="ভূমিকার বর্ণনা লিখুন (ঐচ্ছিক)">{{ old('description') }}</textarea>
            </div>
