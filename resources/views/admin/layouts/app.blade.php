    ...
    <aside id="adminSidebar" data-state="closed"
        ...
        <div class="flex items-center justify-between gap-3 px-5 pb-4 pt-6">
            ...
            <button type="button" id="adminSidebarClose" aria-label="মেনু বন্ধ করুন" class="{{ $iconBtn }} !text-footer-mut hover:!bg-white/[0.06] hover:!text-white lg:hidden">
                <svg class="{{ $navIcon }}" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round">
                    <path d="M6 6l12 12" />
                    <path d="M18 6 6 18" />
                </svg>
            </button>
        ...
        <nav class="mt-auto flex flex-col gap-1 border-t border-white/10 px-3 py-4" aria-label="অ্যাকাউন্ট মেনু">
            <a href="#" class="{{ $menuItem }}">
                <svg class="{{ $navIcon }}" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <path d="M9.6 9.3a2.5 2.5 0 1 1 3.4 2.9c-.7.3-1 .8-1 1.6" />
                    <path d="M12 16.8h.01" />
                </svg>
                সাহায্য
            </a>
        ...
        <header class="sticky top-0 z-100 h-[68px] border-b border-hairline bg-[rgba(250,250,248,0.85)] backdrop-blur-md backdrop-saturate-[140%]">
            <div class="flex h-full items-center justify-between gap-4 px-[clamp(16px,3vw,32px)]">
                <div class="flex items-center gap-2">
                    <button type="button" id="adminMenuToggle" aria-label="মেনু" aria-expanded="false" aria-controls="adminSidebar" class="{{ $iconBtn }} min-[1024px]:hidden">
