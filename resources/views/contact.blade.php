                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        @if (!empty($socials['social_facebook']))
                            <a href="{{ $socials['social_facebook'] }}" target="_blank" rel="noopener" aria-label="ফেসবুক"
                                ...
                                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M14 9V7c0-1 .3-1.5 1.6-1.5H17V2.5h-2.4C11.9 2.5 11 4 11 6.3V9H8.5v3H11v9.5h3V12h2.2l.4-3H14z"/></svg>
                                ফেসবুক
                            </a>
                        @endif
                        @if (!empty($socials['social_twitter']))
                            <a href="{{ $socials['social_twitter'] }}" target="_blank" rel="noopener" aria-label="এক্স"
                                ...
                                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M17.5 3h3l-6.6 7.5L21.7 21h-5.9l-4.3-5.6L6.4 21H3.3l7-8L2.6 3h6l3.9 5.1L17.5 3zm-1 16h1.6L7.6 4.6H5.9L16.5 19z"/></svg>
                                এক্স
                            </a>
                        @endif
