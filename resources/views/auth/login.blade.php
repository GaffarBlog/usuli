                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-8 flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox"
                                   name="remember"
                                   class="h-4 w-4 rounded border-brand-line text-brand focus:ring-brand/20">
                    ...
                    {{-- Submit --}}
                    <button type="submit"
                            class="w-full rounded-full bg-brand px-7 py-3.5 text-base font-semibold text-white transition-all duration-300 hover:-translate-y-px hover:bg-brand-deep">
                        প্রবেশ করুন
                    </button>
                </form>
