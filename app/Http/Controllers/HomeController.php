...
class HomeController extends Controller
{
    ...
    private array $topics = ['গল্প', 'মতামত', 'সংস্কৃতি', 'জীবনযাপন', 'প্রযুক্তি', 'ভ্রমণ', 'বই', 'প্রকৃতি'];
    ...
    public function index(): Response
    {
        return response()->view('home', [
            ...
            'activeNav' => 'প্রচ্ছদ',
            'articles' => array_slice($this->articles, 0, 6),
            'topics' => $this->topics,
    ...
    public function blog(): Response
    {
        $filters = collect([['value' => 'all', 'label' => 'সব']])
            ->merge(collect($this->articles)->pluck('category')->unique()->values()
        ...
        return response()->view('blog', [
            'navItems' => $this->navItems,
            'activeNav' => 'গল্প',
            'totalBn' => strtr((string) count($this->articles), $this->bnDigits),
            'filters' => $filters,
            'visibleArticles' => array_slice($this->articles, 0, 6),
            'extraArticles' => array_slice($this->articles, 6),
        ]);
    }
}
